...
class EOS_Translator:
    ...
    tex_map = {# scan parameters
                  ...
                  "B->K^*::alpha^A0_0@BSZ2015":r"$\alpha^{A_0}_0$",
                  "B->K^*::alpha^A0_1@BSZ2015":r"$\alpha^{A_0}_1$",
                  "B->K^*::alpha^A0_2@BSZ2015":r"$\alpha^{A_0}_2$",
                  "B->K^*::alpha^A1_0@BSZ2015":r"$\alpha^{A_1}_0$",
                  "B->K^*::alpha^A1_1@BSZ2015":r"$\alpha^{A_1}_1$",
                  "B->K^*::alpha^A1_2@BSZ2015":r"$\alpha^{A_1}_2$",
                  "B->K^*::alpha^A12_0@BSZ2015":r"$\alpha^{A_{12}}_0$",
                  "B->K^*::alpha^A12_1@BSZ2015":r"$\alpha^{A_{12}}_1$",
                  "B->K^*::alpha^A12_2@BSZ2015":r"$\alpha^{A_{12}}_2$",
                  "B->K^*::alpha^V_0@BSZ2015":r"$\alpha^{V}_0$",
                  "B->K^*::alpha^V_1@BSZ2015":r"$\alpha^{V}_1$",
                  "B->K^*::alpha^V_2@BSZ2015":r"$\alpha^{V}_2$",
                  "B->K^*::alpha^T1_0@BSZ2015":r"$\alpha^{T_1}_0$",
                  "B->K^*::alpha^T1_1@BSZ2015":r"$\alpha^{T_1}_1$",
                  "B->K^*::alpha^T1_2@BSZ2015":r"$\alpha^{T_1}_2$",
                  "B->K^*::alpha^T2_0@BSZ2015":r"$\alpha^{T_2}_0$",
                  "B->K^*::alpha^T2_1@BSZ2015":r"$\alpha^{T_2}_1$",
                  "B->K^*::alpha^T2_2@BSZ2015":r"$\alpha^{T_2}_2$",
                  "B->K^*::alpha^T23_0@BSZ2015":r"$\alpha^{T_{23}}_0$",
                  "B->K^*::alpha^T23_1@BSZ2015":r"$\alpha^{T_{23}}_1$",
                  "B->K^*::alpha^T23_2@BSZ2015":r"$\alpha^{T_{23}}_2$",
