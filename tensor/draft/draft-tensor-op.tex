...
In the following we consider a {scenario consisting of the
  SM augmented} by dimension-six operators that respect the SM gauge
...
Higgs particle in the SM. The second are the steadily rising lower
...
order of the $W$-boson {mass in~\cite{D'Ambrosio:2002ex}} for vector
...
$\Lambda_{\rm NP}$ is the high-energy scale at which new physics {
is decoupled}.
