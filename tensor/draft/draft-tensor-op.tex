...
\begin{abstract}
  ...
  nonstandard tensorial and scalar contributions are enhanced with respect
  to vectorial ones. We use latest experimental results for $\ell = \mu$ in
  combination with $B_s\to \bar\mu\mu$ to derive stronger model-independent
  constraints on tensorial and scalar effective couplings and determine their
  impact on not yet measured angular observables in
  $B\to K^*\bar\mu\mu$, which feature the same suppression of vectorial couplings.
...
\begin{figure*}
  ...
  \caption{ The sensitivity to the tensorial coupling
...
destructive interference with vectorial couplings $\wilson{9,\,9',\,10,\,10'}$.
...
additional constraints on the real and imaginary parts of vectorial couplings.
...
\bar\mu\mu$ to tensorial couplings (see also \reffig{fig:FHvsCT}). The latter
...
the $A_{\rm FB}^\mu(B\to K\bar\mu\mu)$ requires interference of scalar with tensorial
...
even allowing new physics in vectorial couplings
...
magnitude of vectorial couplings, note that for example the branching ratio of
$B\to K^*\bar\ell\ell$ 
\begin{align}
