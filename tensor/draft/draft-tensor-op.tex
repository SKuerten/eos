...
Both observables exhibit strong suppression factors for vectorial and dipole
...
\hline
    ...
    & $A_{\rm CP}^\mu$
    &  $\,\,\,\,\, q^2 \in [1.1,\, 6.0],\, [15.0,\, 19.0]$ GeV$^2$  & \cite{Aaij:2014bsa}
\\    
\hline \hline
${B\to K}$ form factors
...
\refsec{sec:SM-EFT} and \refsec{sec:tensor:scalar} for $q^2$-integrated quantities 
...
considerations insignificant since current experimental measurements, in
combination with theory uncertainties, do not impose yet too stringent
constraints on tensorial and scalar couplings.

Beyond the SM, $J_{6c}$ can get of order ${\cal O}(10^{-21})$ in all considered
scenarios. Concerning $(J_{1s} - 3\, J_{2s})$ and $(J_{1c} + J_{2c})$, substantial
deviations from the SM prediction are possible only in the presence of non-zero
tensorial couplings up to the ${\cal O}(10^{-20})$ at high-$q^2$ and also
at low-$q^2$ in the case of $(J_{1s} - 3\, J_{2s})$.
...
\item imposes by itself constraints on tensorial couplings \eos{$|{\cal C}_{T,\,T5}|
  ...
  $B\to K^*$ form factors they become tighter \eos{$|{\cal C}_{T,\,T5}| < 0.30\, 
  (0.45)$}, even in the presence of non-standard contributions in vectorial
  couplings $(\wilson{9,10}\neq 0)$.
...
\eos{Contrary to \cite{}, we do not adapt a log-gamma prior for the asymmetric
uncertainty but rather $\ldots$ .}
