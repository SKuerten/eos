...
\begin{figure*}
  ...
  \caption{
    ...
    \bar\mu\mu)$ (blue) and 
    all data in \reftab{tab:observables} (green) marginalising over non-zero 
    $\mbox{Re}(\wilson[NP]{10}) \in [-1,\, 9]$ as well as and 
    $\mbox{Im}(\wilson[NP]{10})$ and $\mbox{Re, Im}(\wilson[NP]{10'}) \in [-5,\,5]$, 
    or all data but $\mbox{Re, Im}(\wilson[NP]{10,\, 10'}) = 0$ (red)
