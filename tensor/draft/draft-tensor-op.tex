...
\bar\ell\ell$ from LHCb \cite{Aaij:2013qta} did not allow to perform a full
...
\cite{Aaij:2013iag} with only 1 fb$^{-1}$, corresponding to the ${\cal
  O}(10^{-8})$, one can indeed hope for some sensitivity to such large effects
in $(J_{1c} + J_{2c})$ and $(J_{1s} - 3\, J_{2s})$ for the not yet published 3
fb$^{-1}$ data set at least with the method of moments~\cite{beaujean:2015mom}.
