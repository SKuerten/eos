...
\begin{figure*}
  \includegraphics[width=.325\textwidth]{plots/pdf/scSP_Bsmumu,scSP_FH,sc910SP_K_KstarBR_Bsmumu_0,2}
%  \includegraphics[width=.32\textwidth]{plots/pdf/scSP_Bsmumu,scSP_FH,sc910SP_K_KstarBR_Bsmumu_4,6}
  ...
  \caption{
    ...
    from $i)$ only $F_H^\mu$~(blue), $ii)$ only $\overline{\cal B}(B_s \to \bar\mu\mu)$ 
    (green) and $iii)$ their combination with other data in \reftab{tab:observables} 
    as well as non-zero $\wilson[]{9,\,9',\,10,\, 10'}$ (red)
...
\todo{uniform priors for $\mbox{Re, Im}(\wilson{i}) \in[-7,\, 7]$}. 
...
\begin{table*}
  ...
  \\
  \hline \hline
  \multicolumn{2}{c|}{$A_{\Delta \Gamma}$}
  & 1
  &
  & SM
  &
