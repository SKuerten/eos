...
\preprint{EOS-2015-??, FLAVOUR(267104)-ERC-??}
...
%  \includegraphics[width=.32\textwidth]{plots/pdf/scSP_Bsmumu,scSP_FH,sc910SP_K_KstarBR_Bsmumu_4,6}
  ...
  \caption{
    ...
    $(\wilson{P}Ê\pm \wilson{P'})$ are identical to $(\wilson{S}Ê\pm \wilson{S'})$,
    apart from a small shift of the contours by $(+0.2,\, +0.15)$.
  }
  \label{fig:scalar}
\end{figure*}
...
\todo{check large SM uncertainty of 30\% at low-$q^2$}
\begin{equation}
\begin{aligned}
...
\begin{enumerate}
\item imposes by itself constraints on tensor couplings $|{\cal C}_{T,\,T5}|
  ...
  $B\to K^*$ form factors they become tighter $|{\cal C}_{T,\,T5}| < 0.33\,
...
\item allows for the first time to bound all four scalar and pseudo-scalar
  ...
  Even when taking into account destructive interference with vector couplings
  $|\wilson{i} + \wilson{i'}| < 0.3\, (0.6)$ and $|\wilson{i} - \wilson{i'}| <
  ...
  by about a factor four. In the future, measurements at LHCb and Belle II will
...
of new physics in vector couplings from destructive interference.

In the future this might change once measurements start to probe the SM expectation,
as in this case constraints on the tensor and scalar couplings become so
stringent that the formal suppression of vector couplings by $m_\ell / \sqrt{q^2}$
