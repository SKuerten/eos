...
\begin{figure*}
  ...
  \caption{ \eos{The sensitivity to the tensorial coupling
      $\wilson{T}$ of $F_H$ [first row], ${\cal B}$ [second row] for
      $B^+ \to K^+ \bar\mu\mu$ and ${\cal B}$ [third row], $J_{1c} +
      J_{2c}$ [fourth row], and $J_{1s}-3 J_{2s}$ for $B^0 \to K^{*0}
      ...
      rations. The bands represent the theory uncertainties at 68\%
