...
given in \cite{Bobeth:2007dw} and \cite{Bobeth:2012vn}, respectively. In the case
of $B\to K\bar\ell\ell$, we refrain from using respective form factor relations at
large and low recoil for the tensor and scalar form factors, $f_T$ and $f_0$ in the
corresponding amplitudes. In the case of $B\to K^*\bar\ell\ell$, we use the scalar
form factor $A_0$ in the scalar and time-like amplitudes, but apply form factor
relations in tensor amplitudes for the tensor form factors $T_{1,2,3}$.
