...
\begin{enumerate}
\item imposes by itself {constraints} on \fred{real and imaginary
    parts of the} tensor couplings \fred{$\wilson{T,\,T5}$} such that the
  upper bound of the smallest 68\% (95\%) credibility interval is
  \fred{$ \lesssim 0.25\, (0.45)$}, superseding previous bounds.  In
  ...
  \fred{$\lesssim 0.23\, (0.39)$}, even in the presence of nonstandard
...
\item for the first time allows to {simultaneously} bound all four
  ...
  account destructive interference with vector couplings, \fred{all
