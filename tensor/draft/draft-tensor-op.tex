...
from ATLAS and CMS such a scenario becomes more and more viable\footnote{\todo{
comment on Cata/Jung \cite{Cata:2015ltad}.}}.
...
The most general fit of complex-valued tensorial and scalar couplings 
$\wilson{S,S',P,P',T,T5}$ in combination with complex-valued vectorial couplings
...
constraints on $\wilson{T,\, T5}$. This demonstrates that even in the case
...
vector couplings, in \refsec{sec:tensor}, \refsec{sec:scalar}
...
$B\to K^*\bar\ell\ell$
\begin{align}
  \frac{1}{\tau_{B^0}} \frac{{\rm d}\BR}{{\rm d}q^2} & =
...
involving tensor couplings and only ${\cal O}(10^{-23})$ in their absence.
...
\begin{enumerate}
\item imposes by itself constraints on tensor couplings \eos{$|{\cal C}_{T,\,T5}|
  ...
  (0.45)$}, even in the presence of non-standard contributions in vector
  couplings.
