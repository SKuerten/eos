...
export PMC_SEED=1361462

export PMC_CHUNKSIZE=1000
export PMC_CLUSTERS=10
...
export UNC_WORKERS=16
export UNC_PMC_INPUT="
    --pmc-input ${BASE_NAME}/sm_uncINCL/pmc_monolithic.hdf5 0 100000
    --pmc-sample-directory /data/final
"
export UNC_PARALLEL=1

export PMC_NUMBER_OF_JOBS=500
export PMC_UNCERTAINTY_INPUT="${BASE_NAME}/sm_uncINCL/pmc_monolithic.hdf5"
