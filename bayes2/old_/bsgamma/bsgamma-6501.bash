...
#SBATCH --mincpus=3
#SBATCH --nodes=1
#SBATCH --output=/scratch/vandyk/bayes2/2013-06-21/bsgamma-6501.out
#SBATCH --error=/scratch/vandyk/bayes2/2013-06-21/bsgamma-6501.err
#SBATCH --time=6:00:00
# vim: set sts=4 et:
...
srun eos-scan-mc \
    ...
    --chunk-size 1000 \
    --seed 6501 \
    --output "${DATADIR}/bsgamma-6501.hdf5"
exit
